...
const ArchitectureDesign = () => {
  return (
    <section class="pt-40 lg:pt-52">
      <div class="container lg:flex gap-10">
        <div class="lg:w-1/2 lg:flex flex-col justify-center">
          ...
          <p class="mt-8 lg:mt-6 lg:text-header-18-medium text-neutral-2">
            ...
            dignissim in elementum. Vitae, ultrices enim commodo ut pretium
          ...
          <div class="flex mt-4 lg:mt-14">
            <button id="show-more-1" class="active text-header-18-medium text-neutral-2">
              Hide
            </button>
            <img id="arrow-1" src="img/Arrow - Right.svg" alt="" class="ml-1" />
          </div>
        </div>
      ...
      <div id="project-section-1" class="container mt-8 lg:mt-14 max-h-[1000px] overflow-visible duration-500">
