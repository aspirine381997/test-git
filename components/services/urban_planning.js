    ...
    <section class="pt-40 lg:pt-52">
      <div class="container lg:flex gap-10">
        <div class="mb-7 lg:mb-0 lg:w-1/2">
          <img src="img/urban planning.jpg" alt="" />
        </div>
        <div class="lg:w-5/12 lg:flex flex-col justify-center">
          ...
          <p class="mt-8 lg:mt-6 lg:text-header-18-medium text-neutral-2">
            ...
            fasdasdaseugiat tortor faucibus. Vel, nisl, quis nibh eget pretium libero,
